          ...
          <div className="getStartedCard">
            <div className="getStarted-header">
              <center>
                ...
                <center>
                  <img src={hosting} alt="Website hosting" />
                </center>
                <p>
                  Every business should know the importance of having an online
                  presence. And every business deserves top notch hosting for
                  not that much a month. $10 a month is a great deal to get your
