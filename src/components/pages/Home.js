      ...
      <div className="HomePage">
        <div className='jumbotron jumbotron-fluid'>
          <h4 style={{ color: 'white' }}>
            I am on Upwork as well! If you have a project that you wish for me to start working on through UpWork,&nbsp;<a href='https://www.upwork.com/freelancers/~017cb997c760da76e7' className="btn btn-dark" rel="noreferrer" target="_blank">hire me</a>&nbsp;there!
          </h4>
        </div>
        <br />
        <h1>
        ...
        <div className='jumbotron jumbotron-fluid'>
          <h4 style={{ color: 'white' }}>
          <p>To view my projects on Github, click <a href='https://github.com/granticusmaximus' className="btn btn-outline-warning" rel="noreferrer" target="_blank">here</a></p>
          </h4>
        </div>
        <Container>
          <Row>
            <Col>
              <img className='image' src={softwareDev} height={400} width={500} />
              <p className='para'>
